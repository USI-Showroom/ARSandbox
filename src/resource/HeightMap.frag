...
void main()
{
    ...
    vec4 level0Txt = texture2D(level0, gl_TexCoord[0].xy);
    vec4 level1Txt = texture2D(level1, gl_TexCoord[0].xy);
    vec4 level2Txt = texture2D(level2, gl_TexCoord[0].xy);
    vec4 level3Txt = texture2D(level3, gl_TexCoord[0].xy);
    vec4 level4Txt = texture2D(level4, gl_TexCoord[0].xy);
